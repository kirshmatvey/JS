...
prevButton.addEventListener('click', function () {
  if (WEB_TECH_IMAGES.indexOf(image.src) === 0) {
    image.src = WEB_TECH_IMAGES[WEB_TECH_IMAGES.length - 1]
  } else {
    image.src = WEB_TECH_IMAGES[WEB_TECH_IMAGES.indexOf(image.src) - 1]
  }
})
nextButton.addEventListener('click', function () {
  if (WEB_TECH_IMAGES.indexOf(image.src) === WEB_TECH_IMAGES.length - 1) {
